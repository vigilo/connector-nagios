...
def makeService(options):
    ...
    from vigilo.connector_nagios.confdb import NagiosConfDB
    ...
    # Du bus vers Nagios
    ncmdh = nagioscmdh_factory(settings, client, confdb)
